...
(function(){
    ...
    (function(){
        ...
        b.lang.Class.prototype.dispatchEvent=function(k,g){
            ...
            k.target=k.target||this;k.currentTarget=this;
    ...
    d.prototype._bindMarker=function(){
        var i=this,j=this._map,h=this._mask;var g=function(l){
            var k=new BMap.Marker(l.point,i.markerOptions);
            j.addOverlay(k);i._dispatchOverlayComplete(k)
        };
    ...
    d.prototype._bindCircle=function(){
        ...
        var j=function(p){
            if(m.controlButton=="right"&&(p.button==1||p.button==0)){
                return}k=p.point;
            i=new BMap.Circle(k,0,m.circleOptions);h.addOverlay(i);
            o.enableEdgeMove();o.addEventListener("mousemove",n);
        ...
        var l=function(q){
            ...
            m._dispatchOverlayComplete(i,p);k=null;
            o.disableEdgeMove();
    ...
    d.prototype._bindPolylineOrPolygon=function(){
        ...
        var l=function(o){
            ...
            j.push(o.point);n=j.concat(j[j.length-1]);
            if(j.length==1){
    ...
    d.prototype._bindRectangle=function() {
        ...
        var m=function(p){
            ...
            n.addOverlay(i);h.enableEdgeMove();
    ...
    e.prototype.draw=function(){
        var i=this._map,g=i.pixelToPoint(new BMap.Pixel(0,0)),h=i.pointToOverlayPixel(g);this.container.style.left=h.x+"px";this.container.style.top=h.y+"px"
    };
    ...
    e.prototype._bind=function(){
        ...
        var o=["click","mousedown","mousemove","mouseup","dblclick"],i=o.length;while(i--){
            b.on(h,o[i],j)
        }
    ...
    e.prototype.mousemoveAction=function(n){
        function g(s){
            var r=s.clientX,q=s.clientY;if(s.changedTouches){
                r=s.changedTouches[0].clientX;
                q=s.changedTouches[0].clientY
            }
            return new BMap.Pixel(r,q)
        }
        var h=this._map,o=this,i=h.pointToPixel(this.getDrawPoint(n)),k=g(n),l=k.x-i.x,j=k.y-i.y;i=new BMap.Pixel((k.x-l),(k.y-j));
    ...
    function a(h,g){
        this.drawingManager=h;g=this.drawingToolOptions=g||{};
    ...
    a.prototype._generalHtml=function(m){
        ...
        var k=[];k.push(n("BMapLib_box BMapLib_hander","hander"));
        for(var j=0,g=this.drawingModes.length; j<g;j++){
            var l="BMapLib_box BMapLib_"+this.drawingModes[j];if(j==g-1){
                l+=" BMapLib_last"
            }
    ...
    a.prototype._bind=function(g){
        ...
        b.on(this.panel,"click",function(k){
            ...
            h.setStyleByDrawingMode(i);h._bindEventByDraingMode(i)
        })
    };
