...
(function() {
    ...
    Uc.getTilesUrl = function(a, b, c) {
        ...
        return "static/tiles/" + z + "/" + x + "/" + y + ".jpg";

       /* Sc = ["online0.map.bdimg.com/tile/","online1.map.bdimg.com/tile/","online2.map.bdimg.com/tile/","online3.map.bdimg.com/tile/","online4.map.bdimg.com/tile/"];
		var d=a.x,a=a.y,e=1,c=Tc[c];
		 this.map.DL()&&(e=2);
		 //var k = (Sc[Math.abs(d+a)%Sc.length]+"?qt=tile&x="+(d+"").replace(/-/gi,"M")+"&y="+(a+"").replace(/-/gi,"M")+"&z="+b+"&styles="+c+"&scaler="+e+(6==x.ea.la?"&color_dep=32&colors=50":"")+"&udt=20160202").replace(/-(\d+)/gi,"M$1");
		 var k = "tiles/"+(Sc[Math.abs(d+a)%Sc.length]+"x="+(d+"").replace(/-/gi,"M")+"&y="+(a+"").replace(/-/gi,"M")+"&z="+b)+".png";
		 return k;*/
