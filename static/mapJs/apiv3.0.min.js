...
window.BMAP_AUTHENTIC_KEY = "DD279b2a90afdf0ae7a3796787a0742e"; (function() {
    function ba(a) {
        throw a;
    }
    var j = void 0,
            ...
            if (d.Bd == this.Fj.cq) c && b();
                ...
                if (d.Bd == this.Fj.pG) {
                    ...
                    e.DC == q && (e.DC = o, setTimeout(function() {
                            ...
                            e.DC = q;
                            e.Pd.Fn.length = 0;
                            //oa(e.iG.$P + "&mod=" + a.join(","))
                        //Pb("../vendor/mapJs/getmodules.js")
                            0 == a.length ? e.XK() : oa("../vendor/mapJs/getmodules.js")
                        },
                        1));
                    d.Bd = this.Fj.JP
                }
    ...
    Yc.getTilesUrl = function(a, b, c) {
        ...
        // return 'http://online2.map.bdimg.com/onlinelabel/?qt=static/images/' + z + "/" + x + "/" + y + ".jpg"
    };
    var La = new Uc("\u5730\u56fe", Yc, {
            tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
            maxZoom: 19
